...
the exported class/editor surface. Its `init:` block rejects
invalid scale construction before an instance escapes. That class instance
crosses the checked dynamic Velar component chunk used for each SVG bar, while
