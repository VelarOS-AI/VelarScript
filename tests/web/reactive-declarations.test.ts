...
// tests/acceptance/browser.acceptance.ts, whose fixture project this file's siblings feed.
// ---------------------------------------------------------------------------
...
const compile = (text: string): ReturnType<typeof compileWeb> => compileWeb(text, { trimStart: true });
