...
import { executeModuleText as executeModule } from "../support/execute-module.ts";
...
test("[P2c-6] the system clipboard publishes a read and a write that read as a pair", () => {
  ...
  // real clipboard is asserted in `tests/acceptance/browser.acceptance.ts`, which had
