...
test("the signal report names the signal, the count, and the file, and degrades to what it knows", () => {
  assert.equal(
    signalTerminationReport("SIGKILL", { completed: 412, file: join(repositoryRoot, "tests", "compiler.test.ts") }, repositoryRoot),
    "the test child was terminated by signal SIGKILL after 412 tests, while running tests/compiler.test.ts",
  );
