...
try {
  ...
  assert.equal(installedManifest.dependencies["@velarscript/compiler"], "0.19.1");
  assert.equal(installedManifest.dependencies["@velarscript/core"], "0.19.1");
  assert.equal(installedManifest.dependencies["@velarscript/node"], "0.19.1");
  assert.equal(installedManifest.dependencies["@velarscript/server"], "0.19.1");
  assert.equal(installedManifest.dependencies["@velarscript/web"], "0.19.1");
  assert.equal(installedManifest.dependencies["@velarscript/desktop"], "0.19.1");
  assert.equal(installedManifest.dependencies["create-velar"], "0.19.1");
  ...
  assert.equal(installedNodeManifest.dependencies["@velarscript/compiler"], "0.19.1");
  ...
  assert.equal(installedServerManifest.dependencies["@velarscript/compiler"], "0.19.1");
  assert.equal(installedServerManifest.dependencies["@velarscript/node"], "0.19.1");
  ...
  for (const dependency of ["@velarscript/compiler", "@velarscript/node", "@velarscript/web"]) {
    assert.equal(installedDesktopManifest.dependencies[dependency], "0.19.1");
  }
  ...
  assert.equal(version.stdout, "velar 0.19.1\n");
...
`.trimStart(), "utf8");
  ...
  assert.equal(docsManifest.dependencies["@velarscript/web"], "0.19.1");
  ...
  assert.equal(componentManifest.peerDependencies["@velarscript/web"], "^0.19.1");
  ...
  assert.equal(nodeManifest.dependencies["@velarscript/server"], "0.19.1");
  ...
  assert.equal(createdDesktopManifest.dependencies["@velarscript/desktop"], "0.19.1");
