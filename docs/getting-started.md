...
release is **0.30.1**, and every toolchain dependency `velar create` writes is
...
```json
{
  "dependencies": {"@velarscript/web": "0.30.1"},
  "devDependencies": {"@velarscript/cli": "0.30.1", "playwright": "^1.58.2"}
}
```
