...
release is **0.31.0**, and every toolchain dependency `velar create` writes is
...
```json
{
  "dependencies": {"@velarscript/web": "0.31.0"},
  "devDependencies": {"@velarscript/cli": "0.31.0", "playwright": "^1.58.2"}
}
```
