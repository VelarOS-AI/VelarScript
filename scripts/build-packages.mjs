...
import { velarBuildOrder } from "./velar-packages.mjs";

/**
 * Build every publishable workspace package that declares a build, in an order
 * where each one follows the workspace packages it depends on.
 *
 ...
 *
 * The order is derived, not preserved: `velarBuildOrder` reads each manifest's
