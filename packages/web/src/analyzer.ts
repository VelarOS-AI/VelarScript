import { mechanicalEdits, mechanicalFix, type Diagnostic, type DiagnosticEdit, type Span } from "@velarscript/compiler";
import {
  Analyzer,
  anyType,
  boolType,
...
import { collectLookStaticScope, evaluateLookStaticExpression, isLookStaticValue, type LookStaticScope, type LookStaticValue } from "./look-static.ts";
...
import { foldedLengthPercentage, isLookNumericType, teachLookLengthSlot, teachLookPercentageSlot } from "./analysis/look-values.ts";
...
import { collectLookDeclarations, lookConditionKey, lookContributions, LOOK_CONDITION_TERM_LIMIT } from "./analysis/look-conditions.ts";
import {
  collectLookBuilderNames,
  collectLookImportSite,
  containsCssImport,
  firstRelativeCssAssetAddress,
  lookConditionTermCount,
  lookJoin,
  lookLiteralZero,
  mentionsLookUnitType,
  type LookImportSite,
  type LookValueSite,
} from "./analysis/look-sites.ts";
import {
  literalStringValues,
  lookColorKeywords,
  lookCssWideKeywords,
  ...
  lookFilterRewrite,
  lookMetricKeywords,
  lookShorthandOverlapMessage,
  lookShorthandStringGuidance,
  lookVocabularyGuidance,
  lookVocabularyLead,
  numericLiteral,
  type LookFilterRewrite,
  type LookValueGuidance,
} from "./analysis/look-vocabulary-guidance.ts";
import {
  flippedViewportComparison,
  isSchemeCondition,
  isViewportComparison,
  lookMediaVocabulary,
  lookSourceOf,
  mediaSubjectShape,
} from "./analysis/media-conditions.ts";
import { RETIRED_ACCESSOR_TYPE, type RetiredAccessorDeclaration } from "./analysis/retired-accessors.ts";
import { checkRoutePath, containsPromise, hasAccessibleJsxContent, hasAccessibleSvgName } from "./analysis/routes.ts";
import { urlSchemeRefusal, WEB_URL_ATTRIBUTES } from "./analysis/url-attributes.ts";
...
import {
  ...
  LOOK_PROPERTY_TYPES,
  nativeDomEventNames,
  removedJsxControlAttributes,
  routeContextIdentity,
  textualWebPrimitiveNames,
  webEventDeadFields,
  webEventType,
  webEventTypeNames,
  webTypeFields,
} from "./analysis/web-types.ts";
