...
function docsTemplate(name: string, displayName: string, version: string, formatVersion: number): ReadonlyMap<string, string> {
  const files = new Map([
    ...
    ["src/styles.vel", `export const ink = Look.rgb(17, 18, 22)\nexport const inkSoft = Look.rgb(94, 96, 102)\nexport const paper = Look.rgb(247, 245, 240)\nexport const paperPure = Look.rgb(251, 250, 247)\nexport const sea = Look.rgb(68, 123, 159)\nexport const seaSoft = Look.rgba(68, 123, 159, 0.12)\nexport const rule = Look.rgba(17, 18, 22, 0.14)\n\nexport const documentLook = look:\n    display = "grid"\n    gap = 18px\n    width = 100%\n    maxWidth = 824px\n    padding = Look.spacing(72px, 32px)\n\nexport const eyebrowLook = look:\n    margin = 0\n    color = sea\n    fontWeight = 700\n    textTransform = "uppercase"\n    letterSpacing = 0.08em\n\nexport const titleLook = look:\n    margin = 0\n    fontSize = Look.clamp(3rem, 8vw, 6rem)\n    lineHeight = 0.96\n    letterSpacing = -0.06em\n\nexport const leadLook = look:\n    margin = 0\n    color = inkSoft\n    fontSize = 1.2rem\n    lineHeight = 1.65\n\nexport const linkLook = look:\n    color = sea\n    fontWeight = 700\n\nexport const codeLook = look:\n    overflow = "auto"\n    padding = 20px\n    border = Look.border(1px, rule)\n    borderRadius = 12px\n    background = paperPure\n`],
