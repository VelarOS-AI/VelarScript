...
import { Analyzer, isCorePrimitiveName, type AnalysisContext, type InitializationImportRead } from "./analyzer.ts";
import { astNodesOfKind, moduleStartupCode } from "./ast.ts";
import type { DynamicImportExpression, ModuleStartupCode, Program } from "./ast.ts";
...
import type { CompilerEmbeddedJavaScriptModule, CompilerEmitter, CompilerEmitterOptions, CompilerExtension, CompilerResourceDependency, CompilerStyleSegments, ModuleInterface } from "./extension.ts";
...
export { inspectJavaScriptModule, MAX_JAVASCRIPT_MODULE_SYNTAX_NODES, MAX_JAVASCRIPT_MODULE_TOKENS, type JavaScriptModuleEdge, type JavaScriptModuleInspection, type JavaScriptModuleInspectionOptions, type JavaScriptOpaqueModuleLoad } from "./javascript-module.ts";
