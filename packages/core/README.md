...
This includes `velar/hash`: its bounded synchronous SHA-256 implementation is
identical across all official targets and depends only on Core binary buffers.
